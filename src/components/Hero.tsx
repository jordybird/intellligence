...
export default function Hero() {
  ...
  return (
    <div className="w-full px-4 md:px-8 py-8 md:py-16 bg-white">
      <div className="flex flex-col md:flex-row gap-8 md:gap-4">
        {/* Left Column */}
        <div className="flex-1 md:w-[60%] relative">
          {/* Text Content */}
          <div className="space-y-4 text-center md:text-left">
            <h1 className="text-3xl md:text-5xl font-medium text-[#28282B] leading-tight">
              GROW YOUR BUSINESS WITH AI-DRIVEN INSIGHTS
            </h1>
            ...
            <div className="relative">
              ...
              >
                <Link
                  href="/get-started"
                  className="flex items-center px-12 py-3.5 bg-[#CBB3FF] text-black font-light text-lg rounded-full transition hover:shadow-lg"
                >
                  Get Started
                </Link>
                <Link
                  href="/get-started"
                  className="flex items-center justify-center w-14 h-14 bg-[#CBB3FF] rounded-full transition hover:shadow-lg overflow-hidden"
                >
                  <motion.div
        ...
        <div className="md:w-[40%]">
          <div className="relative w-full h-[400px] md:h-[500px] bg-[#1A2238] rounded-[2rem] md:rounded-[3rem] overflow-hidden">
            ...
            >
              <Link 
                href="/companies" 
                className="bg-[#CBB3FF] text-black px-4 py-2.5 rounded-full flex items-center gap-3 hover:shadow-lg transition-all"
              >
                <span className="font-medium">+100 Companies</span>
                <div className="w-8 h-8 rounded-full border-2 border-gray-700 flex items-center justify-center overflow-hidden">
                  <motion.div
                    variants={arrowVariants}
                    initial="initial"
